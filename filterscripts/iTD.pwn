...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	{
		if(!SELCs)
		UpdateTextDraw(EditIndex, true, true);
		else
		UpdateTextDraw(EditIndex, true);
		return 1;
	}
...
stock UpdateTextDraw(Index, bool:Show = true, bool:Select = false)
{
	...
	if(Select)
	TextDrawSetSelectable   (Project[Index][iTextdraw], Project[Index][iSelectable]);
	else
	TextDrawSetSelectable   (Project[Index][iTextdraw], 0);
