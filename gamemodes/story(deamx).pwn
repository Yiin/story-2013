...
main()
{
	print("\n\n\n\n\n\n\n\n\n\n\n\n\t\t---:: Story of Cities: Pradþia | by Yiin\n\n\n\n\n\n\n\n\n\n\n\n");
	return 0;
}
...
public OnPlayerClickPlayerTextDraw(playerid, arg1)
{
	...
	if(glob4C050[playerid] == 2)
	{
		...
		if(arg1 == glob51594[playerid])
		{
			...
			{
				format(var0, 124, "{00FF00}Tuðèia\t\t\t\t{FFFFFF}-\t-\t-\n");
...
public OnPlayerClickTextDraw(playerid, arg1)
{
	...
	if(arg1 == glob51B38)
	{
		...
		strcat(glob4D42C, "{89B0FF}ðá serverá kuriame toká, kokiame ir patys norëtumëme þaisti. Visa informacija,\nvisas þaidimo stilius yra perteikti kaip galima kokybiðkiau ir paprasèiau.\n", 2050);
		strcat(glob4D42C, "Þaidimo esmë paprasta. Jûs patys kuriate miestø istorijà, kaupiate kultûros\ntaðkus, uþ kuriuos miesto valdþia stato naujus pastatus, tobulina esamus. \n", 2050);
		strcat(glob4D42C, "Pajamø ðaltinis yra ne vienas, taèiau efektyviausias, þinoma, yra darbas.\nDarbà galima suvokti labai skirtingai. Ið esmës pelningiausia yra kurti savo ámonæ,\n", 2050);
		strcat(glob4D42C, "ádarbinti darbuotojus, ir pardavinëti savo paslaugas. Taèiau á savo verslà\ntenka labai daug investuoti, ir laiko ir pinigø, todël prieð imantis kaþko didelio, teks\n", 2050);
		strcat(glob4D42C, "ir paèiam to pasiekti. Galite dirbti, galite uþsiiminëti nelegalia\nveikla, galite save kelti á kandidatus miesto valdþioje, galite bendradarbiauti su kitais\n", 2050);
		strcat(glob4D42C, "miestais kurdami bendrus projektus, kuriems prireiks bendrø pastangø tam pasiekti.\nGalite bûti pamaldus tikintysis arba keletà miestø valdanèios mafijos krikðtatëvis\n", 2050);
		strcat(glob4D42C, "viskas tik jûsø rankose. Jeigu turite ádomiø ádëjø, mielai kvieèiame jomis pasidalinti.\nÞaidimà siekiame padaryti kuo malonesná, tad istorijà kurkite su atsakomybe :)", 2050);
	...
	if(arg1 == glob51B3C)
	{
		...
		strcat(glob4D42C, "{89B0FF}Prie daugiausiai uþduodamø klausimø ir raðysime daugiausiai uþduodamus \nklausimus, o ne klausimus, kurie kaip kitiems atrodo 'Turëtø bûti daugiausiai uþduodami'.\n\n", 2050);
		strcat(glob4D42C, "{89B0FF}Klausimas: kà reiðkia tas tl;dr po registracijos iððokusiame lange?\n{80FF2B}Atsakymas: Angliðkas trumpinys sakinio 'Too Long; Didnt Read', kuris reiðkia 'Per ilgas, neskaièiau'.\n\n", 2050);
		strcat(glob4D42C, "{89B0FF}Klausimas: ar galiu prisidëti prie projekto, labai graþiai mapinu ir gerai scriptinu.\n{80FF2B}Atsakymas: Kol kas mums per akis uþtenka 3 þmoniø, jeigu mums jûsø prireiks, susirasime patys ;)\n\n", 2050);
		strcat(glob4D42C, "{89B0FF}Klausimas: kur man rasti kur kas randasi, nei minimape iconø yra, nei /gps neveikia.\n{80FF2B}Atsakymas: Minimape yra viena icona - spawn'as. Jame yra þemëlapis, paspausk prie jo ENTER.\n\n", 2050);
		strcat(glob4D42C, "{89B0FF}Klausimas: kodël negaliu iðvaþiuoti ið miesteliø teritorijos?\n{80FF2B}Atsakymas: Nes pagal visà ádëjà tu randiesi vidurá laukø, kur viskà kuri pats, o 3 didmiesèiai ðalia, visai nesiderntø.\n", 2050);
		strcat(glob4D42C, "Reikia LV garaþø, o gal atsibodo tie patys miesteliai? Kaupkit miestui kultûros taðkus, \nmokëkit mokesèius, o tada praðykit valdþios. Ir jà rinkit atsakingai, nes nuo jos daug kas priklauso.\n\n", 2050);
		strcat(glob4D42C, "{89B0FF}Klausimas: kaip nusipirkti adminà, noriu bûti adminas, uþbaninsiu visus èyterius!\n{80FF2B}Atsakymas: Ið esmës dël to ir nëra admino. Pakolkas anti èytas gan neblogai susitvarko ir vienas.", 2050);
	...
	if(arg1 == glob51B40)
	{
		...
		strcat(glob4D42C, "{89B0FF}/fix - sutvarko þinomus bugus.\n", 2050);
		strcat(glob4D42C, "/apie - Visa þaidimo pagrindinë informacija (kaip jau turbût pastebëjai)\n/mech - Mechanikø vidus\n/pause\n/unpause\n/spawn - nekelia á spawnà\n/zvejoti", 2050);
		strcat(glob4D42C, "/carturgus - nukelia á senø maðinø turgø.\n/carturgusv - Nuteleportuoja á maðinø turgaus interjerà (a little bug will appear).\n", 2050);
	...
	if(arg1 == glob51B44)
	{
		...
		strcat(glob4D42C, "Pajamø ðaltinis yra ne vienas, taèiau efektyviausias, þinoma, yra darbas.\nDarbà galima suvokti labai skirtingai. Ið esmës pelningiausia yra kurti savo ámonæ,\n", 2050);
		strcat(glob4D42C, "ádarbinti darbuotojus, ir pardavinëti savo paslaugas. Taèiau á savo verslà\ntenka labai daug investuoti, ir laiko ir pinigø, todël prieð imantis kaþko didelio, teks\n", 2050);
		strcat(glob4D42C, "ir paèiam pasiekti toká lygá. Galite dirbti, galite uþsiiminëti nelegalia\nveikla, galite save kelti á kandidatus á miesto valdþià, galite bendradarbiauti su kitais\n", 2050);
		strcat(glob4D42C, "miestais kurdami bendrus projektus, kuriems prireiks bendrø pastangø tam pasiekti.\nGalite bûti pamaldus tikintysis arba keletà miestø valdanèios mafijos krikðtatëvis\n", 2050);
		strcat(glob4D42C, "viskas tik jûsø rankose. Jeigu turite ádomiø ádëjø, mielai kvieèiame jomis pasidalinti.\nÞaidimà siekiame padaryti kuo malonesná, tad istorijà kurkite su atsakomybe :)", 2050);
	...
	if(arg1 == glob51B48)
	{
		...
		strcat(glob4D42C, "{89B0FF}Mes nesiekiame padaryti þaidimo stiliaus panaðaus á Pay To Win, todël\nvip'ams suteikiame tik asmeniðkai þaidëjui naudingas paslaugas, neátakojant kitø\n", 2050);
		strcat(glob4D42C, "þaidëjø þaidimo. Bûdamas vip'u priklausomai nuo vip lygio gauni puikiø privalumø!\n\n", 2050);
		strcat(glob4D42C, "vip I:   30% maþesnës kainos, 2xp/min, `vip I` maðinos, draugø sàraðas praplëstas \niki 20 draugø, vip nicko spalva.\n\n", 2050);
		strcat(glob4D42C, "vip II:  30% maþesnës kainos, 3xp/min, `vip I` ir `vip II` maðinos, vip namai, \nvip skin'ai, draugø sàraðas praplëstas iki 30 draugø, vip nicko spalva.\n\n", 2050);
		strcat(glob4D42C, "vip III: 30% maþesnës kainos, 5xp/min, `vip I` ir `vip II` ir `vip III` maðinos, \nvip namai, vip skin'ai, draugø sàraðas praplëstas iki 50 draugø, \nvisø ginklø þala 50% didesnë, galimybë raðyti á Global chat'à, vip nicko spalva.\n\n", 2050);
	...
	if(arg1 == glob51B4C)
	{
		...
		strcat(glob4D42C, "{89B0FF}Pagrindinis mygtukas - SPACE. Su juo pilate kurà, atidarinëjat vartus, \nbendraujat su npc, naudojates objektais ir daug ko kito.\n", 2050);
		strcat(glob4D42C, "E - Maðinos uþvedimas, uþgesinimas. \nQ - Iðplëstinis maðinos valdymas.\nN - Nustatymai.\nY - Visa kita.", 2050);
...
public cmd_fix(playerid, arg1)
{
	...
	SendClientMessage(playerid, 0x97FC3CFF, "Jei radai klaidà, praneðk administracijai. Bus atlyginta.");
	return 1;
}
...
public dialog_registracija(playerid, arg1, arg2, arg3)
{
	if(arg1)
	{
		if(!strcmp(arg3, "0"))
		{
			...
			{
				SendClientMessage(playerid, 0xFF1111FF, "O tu dràsus þaisti be slaptaþodþio :o Já pasikeisti visada gali savo nustatymuose.");
			}
			else
			{
				SendClientMessage(playerid, 0xFF1111FF, "O tu dràsi þaisti be slaptaþodþio :o Já pasikeisti visada gali savo nustatymuose.");
			}
		}
		if(strlen(arg3) > 40)
		{
...
public dialog_prisijungimas(playerid, arg1, arg2, arg3)
{
	if(arg1)
	{
		...
		if(!mysql_num_rows(1))
		{
			...
			{
				SendClientMessage(playerid, 0xA9C4E4FF, "Dël naujo slaptaþodþio kreipkis á administracijà. Norëdamas(-a) iðeiti, raðyk /q");
				Kick(playerid);
			}
			glob4AE30[playerid]++;
...
function4D178(playerid)
{
	if(glob4A930[playerid][0] == 1)
	{
		...
		format(var3, 512, "Iðsaugoma. [%s]", function9D970(playerid));
		print(var3);
		GetPlayerPos(playerid, var0, var0, var0);
...
function4E6D8(playerid)
{
	...
	printf("[ STORY ] Þaidëjas ákrautas. [%s]", function9D970(playerid));
	return 1;
}
...
function93738(playerid)
{
	...
	strcat(glob4D42C, "{89B0FF}Kad þaidimas bûtø kiek ámanoma malonesnis, rekomenduoju perskaityti \ninformacijà, pateiktà þemiau. \n\nVisø pirma, praktiðkai visos durys, visi vartai yra darinëjami su ENTER.", 2050);
	...
	strcat(glob4D42C, "Treèia, negadinkite sau nervø ir neeksperementuokite su anti èytu. Að tikrai neturiu \ndidelio noro klausytis kaip èia netyèia viskas buvo, kaip jûs nieko nedarëte, bet \nmaðina pati ", 2050);
	strcat(glob4D42C, "uþsitiuningavo arba kaþkas á jus atsitrenkë ir jûs nuskridote +300km/h \ngreièiu tiesiai á mechanikø garaþà kur jums susitaisë maðina. Serveryje yra \npasiekimø sistema. Visi þaidëjai ", 2050);
	strcat(glob4D42C, "pasiekæ 100k patirties be jokio kicko ar bano nuo \nantièyto, gaus prizà. O að dosnus. Jeigu per visiðkà atsitiktinumà buvote neteisingai \niðmetas ar uþbanintas, ir jeigu tai árodysite ", 2050);
